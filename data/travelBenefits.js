export default (benefits = [
  {
    ...
    coverage: [
      ...
      {
        title: "Overseas Funeral Expsnses",
        benefitPayable: {
          basic: "1,000",
          enhanced: "1,500",
          superior: "2,000"
      ...
      {
        title: "Overseas Hospital Cash Benefit ($200 per 24 hours)",
        benefitPayable: {
          basic: "10,000",
          enhanced: "15,000",
          superior: "20,000"
      ...
      {
        title: "Hospital Cash Benefit in Singapore ($200 per 24 hours)",
        benefitPayable: {
          basic: "600",
          enhanced: "1,000",
          superior: "1,600"
  ...
  },
  {
    ...
    coverage: [
      {
        title:
          "Loss of Baggage and Personal Effects ($500 for each article or pair or set of article)",
        benefitPayable: {
          basic: "3,000",
          enhanced: "5,000",
          superior: "7,000"
      ...
      {
        title: "Delayed Baggage ($100 for every 6 hours)",
        benefitPayable: {
          basic: "1,000",
          enhanced: "1,000",
          superior: "1,000"
      ...
      {
        title: "Travel Delay ($100 for every 6 hours)",
        benefitPayable: {
          basic: "1,000",
          enhanced: "1,000",
          superior: "1,000"
      ...
      {
        title: "Travel Misconnections ($100 for every 6 hours)",
        benefitPayable: {
          basic: "200",
          enhanced: "200",
          superior: "200"
      ...
      {
        title: "Flight Overbooked ($100 for every 6 hours)",
        benefitPayable: {
          basic: "100",
          enhanced: "100",
          superior: "100"
      ...
      {
        title: "Flight Diversion ($100 for every 6 hours)",
        benefitPayable: {
          basic: "1,000",
          enhanced: "1,000",
          superior: "1,000"
